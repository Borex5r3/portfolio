...
function Footer() {
  return (
    <div className="relative h-[100px] sm:h-[150px] lg:h-[200px] xl:h-[240px] 2xl:h-[400px] min-w-[280px] bg-[url('assets/footer-bg-green.jpg')] bg-cover bg-center w-full flex justify-center items-end lg:pb-[20px]">
