...
const Home = () => {
  ...
  return (
    <div
      className={`relative h-[880px] lg:h-screen w-full bg-[url('/src/assets/home-pc.jpeg')] bg-cover bg-center min-w-[280px]`}
    >
      ...
      <div
        className={`h-[880px] lg:h-screen w-full bg-black bg-opacity-60 min-w-[280px]`}
      ></div>
    </div>
  );
};
